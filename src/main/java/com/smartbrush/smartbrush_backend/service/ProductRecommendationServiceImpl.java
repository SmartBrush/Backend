...
public class ProductRecommendationServiceImpl {
    ...
    private static final Map<String, List<String>> EXCLUDE = Map.of(
            "건성 트러블형", List.of("강력세정","강한쿨링","극강쿨링","아이스쿨","쿨샷","멘솔폭발"),
            "지성 트러블형", List.of("고보습오일","실리콘","오일리치","오일 코팅","아르간오일","코코넛오일","호호바오일"),
            "건성 민감형",   List.of("강한향","강력세정","진한향","퍼퓸 강한"),
            "지성 민감형",   List.of("고보습오일","오일리치","오일 코팅","아르간오일","코코넛오일","호호바오일"),
            "건성 비듬형",   List.of("강력세정","강한쿨링","아이스쿨","쿨샷"),
            "지성 비듬형",   List.of("고보습오일","오일리치","오일 코팅"),
            "지성 깔끔형",   List.of("고보습오일","오일리치","오일 코팅"),
            "건성 깔끔형",   List.of("강한쿨링","강력세정","멘솔폭발"),
            "밸런스형",     List.of()
    );
